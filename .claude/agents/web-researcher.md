...
## Context Awareness
This agent operates in the context of a NestJS/TypeScript project (moneycheck). When research relates to technical topics in this stack, prioritize:
- NestJS 11.x ecosystem
- TypeScript-specific resources
- MikroORM 7.x and PostgreSQL tooling
